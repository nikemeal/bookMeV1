...
if (file_exists('../system/application/config/database.php') && (!isset($_POST['submit']))) 
{
?>
				...
				<div class="row-fluid">	
					...
					<div class="span1">&nbsp;</div>
	   				...
	   				<div class="span10 well">
						<center>
						<div class="alert alert-danger"><h3>Database detected</h3></div>
						</center>
	    				
	    				<div class="alert alert-info">
							The installer has detected you already have a database.php file at 
							<code>system/application/config/database.php</code>
							<br>
							This installer is for new installs only.  To upgrade, just copy the
							contents of the zip file over the contents already installed
						</div>
...
{
    copy('config/database.default.php', '../system/application/config/database.php');
