...
class Reports extends CI_Controller 
{
	...
	function room_report($room_id)
	{
		...
		$data['dept_report_count'] = $this->Reports_model->room_report_by_dept_count($room_id, $date_from, $date_to);
		...
		//count dpeartment list and order in asc / count user list and order desc
		//count how many rows in total and display as total bookings for that period
