		...
		<div class="row-fluid">
			...
			<div class="span1">
				...
				?>
					<div class="span10">
						<?php if ($room_count == 0){?>
						<a class="btn span10 btn-warning" href="<?php echo base_url().index_page();?>/settings/rooms/add_room">
						...
						<a class="btn span10 btn-warning" href="<?php echo base_url().index_page();?>/settings/periods/add_period">
						...
						<a class="btn span10 btn-warning" href="<?php echo base_url().index_page();?>/settings/subjects/add_subject">
						...
						<?php if ($year_count == 0){?>				
						<a class="btn span10 btn-warning" href="<?php echo base_url().index_page();?>/settings/years/add_year">
